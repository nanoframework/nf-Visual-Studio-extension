...
namespace Microsoft.VisualStudio.ComponentDiagnostics
{
    ...
    public sealed class ProvideDebugEngineAttribute : ProvideGenericRegistrationAttribute
    {
        public ProvideDebugEngineAttribute( )
            : base( string.Format(@"AD7Metrics\Engine\{0}", CorDebug.EngineGuid.ToString("B")) )
        {
        }
        ...
        //const string COMPlusOnlyDebugEngineCLSID = "{40EDD57B-D8A1-405D-B21A-F5F607F7A6A7}";

        static readonly IReadOnlyDictionary<string, object> Values_ = new Dictionary<string, object>
        { { string.Empty, "nanoFramework Debug Engine" }
        , { "Attach", 0 }
        , { "CallStackBP", 1 }
        , { "CLSID", typeof(CorDebug).GUID }
        , { "ConditionalBP", 1 }
        , { "DataBP", 0 }
        , { "Disassembly", 0 }
        , { "Embedded", 0 }
        ...
        , { "Name", "Managed" }
        , { "NativeInteropOK", 0 }
        , { "PortSupplier", DebugPortSupplier.PortSupplierGuid}
