...
namespace nanoFramework.Tools.VisualStudio.DebugEngine
{
    ...
    internal class AD7Thread : IDebugThread2
    {
        ...
        {
            ThreadContext threadContext = m_engine.DebuggedProcess.GetThreadContext(m_debuggedThread.Handle);
        ...
        int IDebugThread2.EnumFrameInfo(enum_FRAMEINFO_FLAGS dwFieldSpec, uint nRadix, out IEnumDebugFrameInfo2 enumObject)
        {
            ...
            try
            {
                System.Collections.Generic.List<ThreadContext> stackFrames = this.m_debuggedThread.StackFrames;
